...
int main ( void ) {
	...
	std::cout << BKGRND << "== TESTS ex02 ==" << RESET << std::endl << std::endl;
	std::cout << GREEN << "• Uncomment section below to proof that you cannot instantiate the Animal class •" << RESET << std::endl << std::endl;
